...
public class Content {
    ...
    public Content(String title, int duration, Genre genre, LocalDate dateOfPremiere){
        this.title = title;
    ...
    public Content(String title, int duration, Genre genre, LocalDate dateOfPremiere, double score) {
