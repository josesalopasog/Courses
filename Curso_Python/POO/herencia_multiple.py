...
class Hijo(Padre,Madre): # Va heredar el metodo hablar del padre porque fue escrito primero
    pass
...
# Crea una clase Ornitorrinco que herede de otras clases: Vertebrado, Pez, Reptil, Ave y Mamifero, tal que "construyas" un animal que tiene los siguientes métodos 
# y atributos: 
# - poner_huevos()
# tiene_pico = True
# vertebrado = True
...
# Logra que la clase Hijo herede de Padre todos sus métodos y atributos, sobreescribiendo el método hobby() para que se devuelva[1]: 
